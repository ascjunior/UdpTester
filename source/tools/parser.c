...
void init_settings (settings *conf_settings) {
	...
	conf_settings->test.train.num = DEFAULT_TRAIN_NUM;
	conf_settings->test.train.size = DEFAULT_TRAIN_SIZE;
	conf_settings->test.train.interval = DEFAULT_TRAIN_INTERVAL;
